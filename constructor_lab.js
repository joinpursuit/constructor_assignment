...
Vector.prototype.plus = function (vector){
  console.log(Vector.prototype.add)
return  {
  x:(this.x + vector.x), y:(this.y +vector.y)
}
}

Vector.prototype.minus = function(newVector){
  return {
    x:(this.x - newVector.x), y:(this.y -newVector.y)       //new vectors needed to be put in another object
  }
}
