...
Dog.prototype.toString = function () {
    return "Dog's name: " + this.name + ", Dog's breed: " + this.breed + ", Dog's mood: " + this.mood;
}
...
function Movie (name, year, cast, description) {
    this.name = name;
    this.year = year;
    this.cast = cast;
...
let borat = new Movie("Borat", "2006", "Sacha Boran Cohen", "It was an odd film starring Sacha Baron Cohen as a man named Borat who was visiting America from Kazakhstan.")
